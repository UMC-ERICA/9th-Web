    ...
    return (
        <div className="flex items-center p-4 border-b border-gray-200">
            ...
            <div className="flex items-center">
                <button onClick={handleDecreaseCount} className="px-3 py-1 bg-gray-300 text-gray-700 rounded-l hover:bg-gray-400 cursor-pointer">
                    -
                </button>
                <span className="px-4 py-[3px] border-y border-gray-300">{lp.amount}</span>
                <button onClick={handleIncreaseCount} className="px-3 py-1 bg-gray-300 text-gray-700 rounded-r hover:bg-gray-400 cursor-pointer">
                    +
                </button>
            </div>
        </div>
